 ...
 * Turso / libSQL schema.
 *
 * - orders: customer trades submitted from the site
 * - app_settings: live exchange rate (`single_exchange_rate` key)
 * - rates: legacy dual-tier table (optional; site uses app_settings only)
 */
