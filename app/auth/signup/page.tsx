  ...
  return (
    <div className="page-shell hero-gradient flex items-center justify-center py-8 px-4">
      <div className="glass-card flex w-full max-w-md flex-col items-center p-6 sm:p-8">
        ...
        <h2 className="text-2xl font-bold text-emerald-800 mb-1 text-center">Create Account</h2>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-full">
          <div className="relative">
            ...
            <input
              ...
              required
              className="pl-10 border rounded w-full px-3 py-2 focus:outline-none focus:ring-2 focus:ring-emerald-500"
            />
          </div>
              <div className="relative">
            <User className="absolute left-3 top-3 w-5 h-5 text-gray-400" />
            <input
              ...
              className={`pl-10 border rounded w-full px-3 py-2 focus:outline-none focus:ring-2 focus:ring-emerald-500 ${referralLocked ? 'bg-gray-100 cursor-not-allowed' : ''}`}
                />
              </div>
              <div className="relative">
            <User className="absolute left-3 top-3 w-5 h-5 text-gray-400" />
            ...
            <input
              ...
              onChange={e => setPassword(e.target.value)}
                  required
              className="pl-10 pr-10 border rounded w-full px-3 py-2 focus:outline-none focus:ring-2 focus:ring-emerald-500"
            />
